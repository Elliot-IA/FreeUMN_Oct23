...
document.addEventListener("keypress",(e)=>{
    ...
    if(e.keyCode == 32){
        ...
        if(pageState == "webcamPictureReady"){
            ...
            // ------------------------- SEBASTIAN HERE ---------
            document.getElementById("liveLoadingData").style = "display: inline-block";
            ...
            if(passVal){
                fetch("/getAddJSDone").then((res)=>(res.json())).then((data)=>{
                    console.log("All Data Has Been Received" + data.test);
                                        
                    lowerCurtain("pass");
                    
                    a("LoadingImage").src="https://creazilla-store.fra1.digitaloceanspaces.com/cliparts/7795378/tango-style-green-checkmark-clipart-xl.png";
                    a("partAddedText").innerHTML = "Item Added!";
...
function lowerCurtain(passFailStr){
    ...
    if(passFailStr == "pass"){
        document.getElementById("PartAdded").style = "display: none";
    ...
    setTimeout(()=>{
        ...
        $("#PartAdded")[0].style = "display: none";
        document.getElementById("thankYouMessage").style = "display:block";
        
        $("#LoadingImage")[0].src = "https://i.gifer.com/ZKZg.gif";
        $("#partAddedText")[0].innerHTML = "Adding Item to Inventory...";
        addAllCats();
...
function resetFrontend(){
    ...
    document.getElementById("liveLoadingData").style = "display: none";
}
